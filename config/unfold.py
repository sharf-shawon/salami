...
UNFOLD = {
    ...
    "ENVIRONMENT": "config.unfold.environment_callback",  # environment name in header
                ...
                "items": [
                    {
                        ...
                        "badge": "config.unfold.badge_callback",
...
def dashboard_callback(request, context):
    ...
    context.update(
        {
            # this will be injected into templates/admin/index.html
            "sample": "example",
        },
    )
    return context
...
def environment_callback(request):
    """
    Callback has to return a list of two values represeting text
    value and the color type of the label displayed in top right corner.
    """
...
def permission_callback(request):
    return request.user.has_perm("config.unfold.change_model")
